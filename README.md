...
│   ├── test_clipboard_monitor.py  # Monitor unit tests (79 tests)
...
├── .github/
│   └── workflows/test.yml         # CI — runs 197 tests on Python 3.10–3.12
...
Contributions are welcome. See [CONTRIBUTING.md](CONTRIBUTING.md) for setup instructions, project structure, coding guidelines, and how to run the test suite (197 tests, no GTK or D-Bus required).
